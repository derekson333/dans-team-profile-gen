...
// function to create the template literal HTML page
function makeHtml() {
...
// function to write HTML for a new member added as template literal
...
// function to end the div when no more employees are added
function closeHtml() {
    const html = ` </div>
    </div>
